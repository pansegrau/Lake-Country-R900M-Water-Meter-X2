...
while true; do
  ...
  echo "Irrigation Consumption calculated at 1 AM"
  echo "Irrigation Consumption 6PM to 9PM PDT was  Zone A: $zoneA Litres : $flowzoneA Litres per min"
  echo "Irrigation Consumption 9PM to Midnight was Zone B: $zoneB Litres : $flowzoneB Litres per min"
  ...
  echo "Irrigation Consumption 9AM to Noon PDT was Zone F: $zoneF Litres : $flowzoneF Litres per min"
